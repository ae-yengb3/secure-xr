  ...
  return (
    <div className="min-h-screen bg-[#121212] flex flex-col">
      <div className="container mx-auto px-4 py-8">
        <Link href="/" className="inline-flex items-center text-[#0080ff] hover:text-[#0060cc] mb-8">
        ...
        <div className="max-w-md mx-auto bg-[#1a1a1a] rounded-xl border border-gray-800 p-8">
          ...
          <h1 className="text-2xl font-bold text-center mb-6">Login to SecureScanX</h1>
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              ...
              <div className="flex justify-end">
                <Link href="/forgot-password" className="text-sm text-[#0080ff] hover:underline">
                  Forgot Password?
                </Link>
              </div>

              <Button type="submit" className="w-full bg-[#0080ff] hover:bg-[#0060cc] text-white" disabled={isLoading}>
